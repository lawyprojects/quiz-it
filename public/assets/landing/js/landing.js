      ...
      $("#myonoffswitch55").on("click", function () {
        if (this.checked) {
          ...
          document
            ...
            .setAttribute(
              "href",
              "https://laravelui.spruko.com/adminor/build/assets/plugins/bootstrap/css/bootstrap.rtl.min.css"
            );
      ...
      $("#myonoffswitch54").on("click", function () {
        if (this.checked) {
          ...
          document
            ...
            .setAttribute(
              "href",
              "https://laravelui.spruko.com/adminor/build/assets/plugins/bootstrap/css/bootstrap.min.css"
            );
          var carousel = $(".owl-carousel");
          $.each(carousel, function (index, element) {
            // element == this
...
function resetData() {
  ...
  $('body').removeClass('rtl');
  $("head link#style").attr("href", $(this));
  (document.getElementById("style").setAttribute("href", "https://laravelui.spruko.com/adminor/build/assets/plugins/bootstrap/css/bootstrap.min.css"));
  var carousel = $('.owl-carousel');
  $.each(carousel, function (index, element) {
      // element == this
      var carouselData = $(element).data('owl.carousel');
