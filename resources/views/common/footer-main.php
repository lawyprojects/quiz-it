                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-sm-6 col-md-4 reveal revealleft">
                                            ...
                                            <ul class="mb-5 mb-lg-0 ps-0">
                                                ...
                                                <li><a href="chart-morris.html">Charts</a></li>
                                        ...
                                        <div class="col-lg-2 col-sm-6 col-md-4 reveal revealleft">
                                            ...
                                            <ul class="mb-5 mb-lg-0 ps-0">
                                                ...
                                                <li><a href="settings.html">Services</a></li>
                                        ...
                                        <div class="col-lg-4 col-sm-12 col-md-4 reveal revealleft">
                                            <div class="">
                                                <a href="index-2.html"><img loading="lazy" alt="" class="logo mb-3"
                                                        src="build/assets/img/brand/logo-white.png"></a>
                                    ...
                                    <div class="row ">
                                        <div class="col-md-12 col-sm-12">
                                            Copyright © <span id="year"></span> <a
                                                href="javascript:void(0)">Adminor</a>.
