    ...
    <div class="container-fluid main-container ">
        <div class="main-header-left ">
            ...
            <div class="responsive-logo">
                <a href="index-2.html" class="header-logo"><img src="assets/img/brand/logo.png" class="logo-11"
                        alt="logo"></a>
                <a href="index-2.html" class="header-logo"><img src="assets/img/brand/logo-white.png"
                        ...
                        <div class="dropdown nav-item main-header-notification">
                            ...
                            <div class="dropdown-menu">
                                <div class="menu-header-content bg-primary text-start d-flex rounded-top-5">
                                    <div class="">
                                        <h6 class="menu-header-title text-white mb-0">4 New Notifications
                                        </h6>
                                    </div>
                                    <div class="my-auto ms-auto">
                                        <a class="badge bg-pill bg-success float-end" href="javascript:void(0);">Mark
                                            All Read</a>
                                    </div>
                                </div>
                                ...
                                <div class="dropdown-footer text-center">
                                    <a href="notification.html" class="btn  btn-primary w-md tx-13">View
                                        All<i class="fe fe-arrow-right tx-12 ms-2 lh-1"></i></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="dropdown-menu">
                                <div class="menu-header-content bg-primary text-start d-flex rounded-top-5">
                                    ...
                                    <div class="my-auto mg-s-auto">
                                        <a class="badge bg-pill bg-info float-end" href="javascript:void(0);">Mark All
                                            Read</a>
                                    </div>
                                </div>
                                <div class="main-message-list chat-scroll">
                                    <a href="mail.html" class="p-3 d-flex border-bottom">
                                        <div class="drop-img cover-image"
                                            data-bs-image-src="assets/img/users/9.jpg">
                                            <span class="avatar-status bg-teal"></span>
                                        </div>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                                                <h5 class="mb-1 name">Ahaija Neru</h5>
                                                <p class="time mb-0 text-end ms-auto float-end">20 min ago
                                                </p>
                                            </div>
                                    ...
                                    <a href="mail.html" class="p-3 d-flex border-bottom">
                                        <div class="drop-img  cover-image  "
                                            data-bs-image-src="assets/img/users/3.jpg">
                                            <span class="avatar-status bg-teal"></span>
                                        </div>
                                        ...
                                        <div class="wd-90p">
                                            <div class="d-flex">
                                                ...
                                                <p class="time mb-0 text-end ms-auto float-end">10 min ago
                                                </p>
                                            </div>
                                    ...
                                    <a href="mail.html" class="p-3 d-flex border-bottom">
                                        <div class="drop-img cover-image"
                                            data-bs-image-src="assets/img/users/5.jpg">
                                            <span class="avatar-status bg-teal"></span>
                                        </div>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                                                <h5 class="mb-1 name">Petey Cruiser</h5>
                                                <p class="time mb-0 text-end ms-auto float-end">35 min ago
                                                </p>
                                            </div>
                                            <p class="mb-0 desc">I'm sorry but i'm not sure how...</p>
                                        </div>
                                    ...
                                    <a href="mail.html" class="p-3 d-flex border-bottom">
                                        <div class="drop-img cover-image"
                                            data-bs-image-src="assets/img/users/12.jpg">
                                            <span class="avatar-status bg-danger"></span>
                                        </div>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                                                <h5 class="mb-1 name">Barney Cull</h5>
                                                <p class="time mb-0 text-end ms-auto float-end">30 min ago
                                                </p>
                                            </div>
                                    ...
                                    <a href="mail.html" class="p-3 d-flex border-bottom">
                                        <div class="drop-img cover-image"
                                            data-bs-image-src="assets/img/users/2.jpg">
                                            <span class="avatar-status bg-teal"></span>
                                        </div>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                                                <h5 class="mb-1 name">Sahar Dary</h5>
                                                <p class="time mb-0 text-end ms-auto float-end">13 min ago
                                                </p>
                                            </div>
                                ...
                                <div class="dropdown-footer text-center">
                                    <a href="mail.html" class="btn   btn-primary  w-md tx-13">View All<i
     ...
     c0.7-0.6,1.8-1.6,3.1-2.8C127,108.2,126.7,101.6,122.3,97.9z" class="color343433 svgShape" />
                                                ...
                                                <span class="mt-2 tx-14  text-center">Contact</span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                <div class="dropdown-footer text-center">
                                    <a href="settings.html" class="btn  btn-primary w-md tx-13">View All<i
                                            class="fe fe-arrow-right tx-12 ms-2 lh-1"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="dropdown main-profile-menu nav nav-item nav-link">
                            <a class="profile-user d-flex" href="javascript:void(0)"><img
                                    src="assets/img/users/5.jpg" alt="user-img"
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="profile.html"><i class="fe fe-edit"></i>
                                    Edit Profile</a>
                                <a class="dropdown-item" href="profile.html"><i class="fe fe-clock"></i>
                                    Activity Logs</a>
                                <a class="dropdown-item" href="profile.html"><i class="fe fe-user"></i>
                                    My Profile</a>
                                <a class="dropdown-item" href="profile.html"><i class="fe fe-settings"></i> Account
                                    Settings</a>
                                <a class="dropdown-item" href="login.html"><i class="fe fe-log-out"></i>
                                    Sign Out</a>
                            </div>
                        </div>
                    </div>
